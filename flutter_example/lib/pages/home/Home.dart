...
import 'package:flutter_example/pages/home/HomeView.dart';
import 'package:flutter_example/entities/UserEntity.dart';
import 'package:flutter_example/utils/AppPageRoute.dart';
...
class HomeState extends State<Home>
  ...
  @override
  Widget build(BuildContext context) => new HomeView(this, widget);
  ...
  void onItemClicked(int index) {
    ...
    Navigator.of(context)
        .push(new AppPageRoute(new Detail(widget.users[index])));
  }
